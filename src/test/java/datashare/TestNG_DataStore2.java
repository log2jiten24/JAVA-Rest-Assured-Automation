...
public class TestNG_DataStore2 {
	...
	//private int bookingID ;
		...
		public void createBooking () {
			...
			//to get the Thread Count to get the Parallel Execution 
			 System.out.println ("Thread ID is : -------> " + Thread.currentThread().getId() + 
					 "Create Booking ID ---> " + DataStoreAsMap.getValue("bookingid"));
		}
		...
		//to get the Thread Count to get the Parallel Execution 
		 System.out.println ("Thread ID is : -------> " + Thread.currentThread().getId() + 
				 "Retrieved  Booking ID ---> " + DataStoreAsMap.getValue("bookingid"));
			
		//Retrieve the Booking Id from the Map - whose return type is Object and cast It 
		int book_id = (int) DataStoreAsMap.getValue("bookingid");
